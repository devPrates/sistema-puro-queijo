...
const mockCategories = [
  { id: "description", label: "Description", content: "Fam locavore kickstarter distillery...", image: "/placeholder.svg", color: "Blue", size: "Medium", quantity: 4 },
  { id: "reviews", label: "Reviews", content: "Customer reviews go here...", image: "/placeholder.svg", color: "Red", size: "Large", quantity: 2 },
  { id: "details", label: "Details", content: "Product details and specifications...", image: "/placeholder.svg", color: "Green", size: "Small", quantity: 6 },
];
